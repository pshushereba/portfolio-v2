            ...
            <div className="flex justify-around">
              ...
              <div className="w-2/5 self-center">
                <p className="text-white w-3/5 leading-relaxed text-xl">
                  I am a detail oriented full stack web developer with a
                  research background. When I'm not developing, you can find me
                  reading, deep diving on new programming technologies, or
            ...
            <div className="w-1/4">
              ...
              <div className="w-3/4">
                <p className="text-white">
                  ...
                  REST API built using Node, Express, Knex and Postgres.
                  Deployed to Heroku.
                </p>
              </div>
            </div>
